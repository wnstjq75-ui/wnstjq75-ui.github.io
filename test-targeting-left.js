...
assert(section.indexOf('channel-console') !== -1, 'premium channel console');
assert((section.match(/<article>/g) || []).length >= 4, 'channel genre tiles');
assert(section.indexOf('targeting-report__flow') === -1, 'old channel step boxes removed');
